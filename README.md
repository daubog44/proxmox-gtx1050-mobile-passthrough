...
```bash
curl -fLO https://github.com/daubog44/proxmox-gtx1050-mobile-passthrough/releases/download/omarchy-control-v0.2.2/omarchy-control-0.2.2-linux-x86_64.rpm
sudo dnf install ./omarchy-control-0.2.2-linux-x86_64.rpm
omarchy-control
```
...
```powershell
$installer = "$env:TEMP\omarchy-control-0.2.2-windows-x64-setup.exe"
Invoke-WebRequest "https://github.com/daubog44/proxmox-gtx1050-mobile-passthrough/releases/download/omarchy-control-v0.2.2/omarchy-control-0.2.2-windows-x64-setup.exe" -OutFile $installer
...
```bash
curl -fLo Omarchy-Control.dmg https://github.com/daubog44/proxmox-gtx1050-mobile-passthrough/releases/download/omarchy-control-v0.2.2/omarchy-control-0.2.2-darwin-aarch64.dmg
...
```bash
curl -fLo Omarchy-Control.dmg https://github.com/daubog44/proxmox-gtx1050-mobile-passthrough/releases/download/omarchy-control-v0.2.2/omarchy-control-0.2.2-darwin-x64.dmg
open Omarchy-Control.dmg
```
