...
def main() -> None:
    ...
    require(
        ...
        (
            ...
            "sm_61",
            "hevc_nvenc",
            "omarchy_stream_resolution",
            "omarchy_stream_health",
            "SUNSHINE_CLIENT_WIDTH",
            "hyprctl eval",
            "Clipboard: il limite e' del protocollo Moonlight",
            "DLNA serve a inviare media registrati",
            "46 Mbps",
            "MoonlightDefault",
            "`enc`: il motore di codifica",
            "KDE Connect",
    ...
    for local_path in (
        ...
        ROOT / "clients" / "moonlight-windows-settings.ps1",
        ROOT / "clients" / "kde-connect-windows-setup.ps1",
    ...
    require(
        ...
        (
            ...
            "stream-health",
            "omarchy_stream_resolution",
            "modalita richiesta da Moonlight",
            "idempotente",
        ),
